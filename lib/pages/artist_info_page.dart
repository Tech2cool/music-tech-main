...
class _ArtistInfoPageState extends State<ArtistInfoPage> {
  ...
  fetchPlayList() async {
    ...
    try {
      ...
      await audioServiceProvider.getArtistByid(widget.music);
    } catch (e) {
      //
    } finally {
      setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    final artistInfo = audioServiceProvider.currentArtistInfo;
              ...
              children: [
                ...
                ConstrainedBox(
                  ...
                  child: TabBarView(
                    ...
                    children: [
                      TopSongsTab(audioServiceProvider: audioServiceProvider),
                      TopAlbumsTab(audioServiceProvider: audioServiceProvider),
                      TopMix(
                        audioServiceProvider: audioServiceProvider,
                      ),
                      FeaturedTab(audioServiceProvider: audioServiceProvider),
                      SimilarArtistTab(
                        audioServiceProvider: audioServiceProvider,
                      ),
                    ],
...
class TopSongsTab extends StatelessWidget {
  ...
  const TopSongsTab({super.key, required this.audioServiceProvider});
  @override
  Widget build(BuildContext context) {
    final artistInfo = audioServiceProvider.currentArtistInfo;
...
class TopAlbumsTab extends StatelessWidget {
  const TopAlbumsTab({super.key, required this.audioServiceProvider});
  final AudioServiceProvider audioServiceProvider;
...
class TopMix extends StatelessWidget {
  ...
  const TopMix({super.key, required this.audioServiceProvider});
...
class FeaturedTab extends StatelessWidget {
  const FeaturedTab({super.key, required this.audioServiceProvider});
  final AudioServiceProvider audioServiceProvider;
...
class SimilarArtistTab extends StatelessWidget {
  const SimilarArtistTab({super.key, required this.audioServiceProvider});
  final AudioServiceProvider audioServiceProvider;
