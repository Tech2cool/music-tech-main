...
import 'package:music_tech/components/skeleton_horizontal.dart';
...
class _SearchPageState extends State<SearchPage> {
  ...
  void _onSearchChanged(String query) {
    ...
    _debounce = Timer(const Duration(milliseconds: 500), () {
      ...
      if (query.isNotEmpty) {
        ...
        audioServiceProvider.resetSearch();
      }
    });
  }
  ...
  Future<void> _fetchSuggestions(String query) async {
    try {
      ...
      await audioServiceProvider.searchMusic(query, selectedFilter!);
    } catch (e) {
  ...
  Widget build(BuildContext context) {
    ...
    final searchResult = audioServiceProvider.searchResult;
    const dropDownItems = [
      DropdownMenuItem(
        value: "ALL",
        child: Text("All"),
